import { Calendar, FileText, Filter, FolderOpen, RefreshCw, Search, Sparkles, Tag, Trash2 } from "lucide-react";
...
const MOCK_REPO_FILES: RepoFile[] = [
  { id: "r1", name: "Chapter 5 – Photosynthesis.pdf", subject: "Biology", type: "pdf", uploadedAt: "2026-06-08", tags: ["Chapter 5", "Lecture"], examCount: 2, size: "2.4 MB" },
  { id: "r2", name: "Algebra Week 3 – Quadratic Equations.docx", subject: "Mathematics", type: "docx", uploadedAt: "2026-06-07", tags: ["Week 3", "Lecture", "Algebra"], examCount: 1, size: "1.1 MB" },
  { id: "r3", name: "World War II – Primary Sources.pdf", subject: "History", type: "pdf", uploadedAt: "2026-06-05", tags: ["WWII", "Sources"], examCount: 3, size: "5.2 MB" },
  { id: "r4", name: "Atomic Structure – Slides.pptx", subject: "Chemistry", type: "pptx", uploadedAt: "2026-06-03", tags: ["Atoms", "Chapter 2"], examCount: 0, size: "8.7 MB" },
  { id: "r5", name: "Newton's Laws of Motion.pdf", subject: "Physics", type: "pdf", uploadedAt: "2026-05-30", tags: ["Newton", "Forces", "Chapter 3"], examCount: 4, size: "3.1 MB" },
  { id: "r6", name: "Shakespeare Sonnets – Analysis.txt", subject: "Literature", type: "txt", uploadedAt: "2026-05-28", tags: ["Poetry", "Shakespeare"], examCount: 1, size: "0.3 MB" },
];
...
export function Repository({ uploadedFiles, onRegenerateExam, onNavigateToExam }: RepositoryProps) {
  ...
  const allFiles = [
    ...MOCK_REPO_FILES.filter((f) => !uploadedIds.has(f.id)),
    ...uploadedFiles.map((f) => ({
    ...f,
