import { CheckCircle, ChevronDown, ChevronUp, Clock, Download, FileText, Loader2, Sparkles, X } from "lucide-react";
...
export function ExamGenerator({ availableFiles, onExamGenerated }: ExamGeneratorProps) {
  const [selectedFiles, setSelectedFiles] = useState<string[]>(availableFiles[0] ? [availableFiles[0].id] : []);
  const [examTitle, setExamTitle] = useState("Biology Chapter 5 – Photosynthesis Exam");
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
          ...
          <div className="md:col-span-2 flex flex-col gap-4">
            ...
            <button
              ...
              style={{
                backgroundColor: generating || selectedFiles.length === 0 ? "#93979f" : "#181d27",
                color: "#fff",
                borderRadius: 9999,
                padding: "14px 24px",
                fontSize: 14,
                ...
                border: "none",
                cursor: generating || selectedFiles.length === 0 ? "not-allowed" : "pointer",
                display: "flex",
                alignItems: "center",
                ...
                <div style={{ background: "linear-gradient(135deg, #b47dff 11%, #7b2fe8 78%)", padding: "24px 24px" }}>
                  <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 12 }}>
                    ...
                    <div style={{ display: "flex", gap: 8 }}>
                      <button style={{ display: "flex", alignItems: "center", gap: 6, backgroundColor: "rgba(255,255,255,0.15)", color: "#fff", borderRadius: 9999, padding: "7px 14px", border: "none", cursor: "pointer", fontSize: 12, fontWeight: 600 }}>
